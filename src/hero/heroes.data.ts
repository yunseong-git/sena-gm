...
export const HeroesData = [
    {
        ...
        skills: [
            ...
            {
                skillIndex: HERO_SKILL_ENUM.SKILL_2,
                description: '(아군전체) 3턴링크, 디벞1개해제, cc면역',
            },
            {
                skillIndex: HERO_SKILL_ENUM.NORMAL_ATTACK,
                description: '(단일) 1타',
            },
            {
    ...
    {
        name: "스파이크", type: HERO_TYPE_ENUM.ALLROUND, rank: HERO_RANK_ENUM.SSR, skills: [
            {
                skillIndex: HERO_SKILL_ENUM.SKILL_1,
    ...
    {
        name: "제이브", type: HERO_TYPE_ENUM.ALLROUND, rank: HERO_RANK_ENUM.SSR, skills: [
            {
                skillIndex: HERO_SKILL_ENUM.SKILL_1,
    ...
    {
        name: "크리스", type: HERO_TYPE_ENUM.ALLROUND, rank: HERO_RANK_ENUM.SSR, skills: [
            {
                skillIndex: HERO_SKILL_ENUM.SKILL_1,
                description: '(5인) 1타, 기절, 대상수 비례 뎀증',
            },
    ...
    {
        name: "바네사", type: HERO_TYPE_ENUM.MAGIC, rank: HERO_RANK_ENUM.SSR, skills: [
            {
                skillIndex: HERO_SKILL_ENUM.SKILL_1,
                description: '(5인) 1타, 기절, 대상수 비례 뎀증',
            },
    ...
    {
        name: "파이", type: HERO_TYPE_ENUM.ATTACK, rank: HERO_RANK_ENUM.UR, skills: [
            {
                skillIndex: HERO_SKILL_ENUM.SKILL_1,
                description: '(5인) 1타, 기절, 대상수 비례 뎀증',
            },
    ...
    {
        name: "로지", type: HERO_TYPE_ENUM.ALLROUND, rank: HERO_RANK_ENUM.UR, skills: [
            {
                skillIndex: HERO_SKILL_ENUM.SKILL_1,
                description: '(5인) 1타, 기절, 대상수 비례 뎀증',
            },
    ...
    {
        name: "쥬리", type: HERO_TYPE_ENUM.MAGIC, rank: HERO_RANK_ENUM.UR, skills: [
            {
                skillIndex: HERO_SKILL_ENUM.SKILL_1,
                description: '(5인) 1타, 기절, 대상수 비례 뎀증',
            },
